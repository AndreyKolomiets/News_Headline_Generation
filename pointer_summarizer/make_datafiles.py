...
def get_art_abs(story_file):
    ...
    # because many image captions don't end in periods; consequently they end up in the body of the article
    # as run-on sentences)
...
# TODO: очевидно, есть смысл запустить с makevocab=True
def write_to_bin(url_file, out_file, makevocab=False):
    ...
    with open(out_file, 'wb') as writer:
        for idx, s in enumerate(story_fnames):
            ...
            # TODO: здесь поправить, чтобы парсил только текст
