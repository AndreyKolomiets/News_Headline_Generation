...
from rl_summ2.train_util import get_cuda
...
class Beam(object):
    def __init__(self, start_id, end_id, unk_id, hidden_state, context):
        ...
        self.scores[0][
            0] = 0  # At time step t=0, all beams should extend from a single beam.
        # So, I am giving high initial score to 1st beam
    ...
    def advance(self, prob_dist, hidden_state, context, sum_temporal_srcs, prev_s):
        """Perform beam search:
        Considering the probabilites of given n_beam x n_extended_vocab words,
